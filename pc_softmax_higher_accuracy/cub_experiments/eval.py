...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    logit_end = tf.nn.softmax(logits)
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        ...
        'Recall_5': slim.metrics.streaming_recall_at_k(
            logits, labels, 5),
        'F1_Score': slim.metrics.f1_score(one_hot_label, logit_end),
        'mean_per_class_accuracy': tf.compat.v1.metrics.mean_per_class_accuracy(labels, predictions, logits.shape[1]),
